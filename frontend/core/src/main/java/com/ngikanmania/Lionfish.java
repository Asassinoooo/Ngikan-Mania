...
public class Lionfish extends BaseFish {
    @Override
    public void init(float x, float y, float vx, float vy, Texture texture, IMovementStrategy strategy, FishType type) {
        ...
        TextureRegion currentFrame = Assets.getInstance().lionfishAnimation.getKeyFrame(0f);
    ...
    public void draw(SpriteBatch batch) {
        TextureRegion currentFrame = Assets.getInstance().lionfishAnimation.getKeyFrame(stateTime);
